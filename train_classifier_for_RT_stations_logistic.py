...
for st in np.arange(nStations):
	...
	filename = 'saved_classifiers' + '/' 'LOGISTIC_lbfgs_UPPERRIGHT_stationInd_' + str(stationInd) + '_' + 'ROI_' + str(maskType) + '_AVGREMOVE_' + str(removeAvg)  + '_filter_' + str(filterType) + '_k1_' + str(k1) + '_k2_' + str(k2)  + '.sav'
