...
# z score BEFORE taking out the TRs you want!!
...
training_data_classifier_SRM = np.zeros((num_subs-2,vox_num*nTR_new))
...
if lowhigh == 1:
	save_str = 'accuracy_SRM_randomized/accuracy_LOW_k1_' + str(k1) + '_k2_' + str(k2) + '_rep_' + str(iter_number) + 'storyTRz.npy'
elif lowhigh == 2:
	save_str = 'accuracy_SRM_randomized/accuracy_HIGH_k1_' + str(k1) + '_k2_' + str(k2) + '_rep_' + str(iter_number) + 'storyTRz.npy'
