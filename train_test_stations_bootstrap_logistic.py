...
# let's only test the ones that we're actually using!!
...
save_str = 'logistic_test/rtAtten_UPPER_RIGHT_winners_nofilter_no_replace' + '_ROI_' + str(maskType) + 'C_param' + str(C_param) + '_AVGREMOVE_' + str(removeAvg)  + '_filter_' + str(filterType) + '_k1_' + str(k1) + '_k2_' + str(k2)  + '_perm_' + str(array_number) + '.npz'
