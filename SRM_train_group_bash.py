...
k1 = np.int(sys.argv[1])
k2 = np.int(sys.argv[2])
...
print(allnames)
print('***')
filename = 'aggregated_SRM_' + str(k1) + 'f_removed.npy'
...
features = k2
print('num k1 features is %i' % k1)
print('num k2 features is %i' % features)
n_iter=20

accuracy = np.zeros(n_per_category)
for f in np.arange(n_per_category):
...
save_str = 'accuracy_k1_' + str(k1) + '_k2_' + str(k2) + '.npy'
