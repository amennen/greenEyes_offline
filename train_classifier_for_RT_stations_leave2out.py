...
subs_to_keep = np.arange(1,37)
num_subs = len(subs_to_keep)
n_per_category = int(num_subs/2)
...
for st in np.arange(nStations):
    ...
    # MEGA_stationInd= first round of stations chosen--shorter ones
    # MEGA2--adding longer ones
    # COMBINED -- new version with mega2 and upper right stations
    #filename = 'saved_classifiers' + '/' 'MEGA_stationInd_' + str(stationInd) + '_' + 'ROI_' + str(maskType) + '_AVGREMOVE_' + str(removeAvg)  + '_filter_' + str(filterType) + '_k1_' + str(k1) + '_k2_' + str(k2)  + '.sav'
    filename = 'saved_classifiers' + '/' 'leave_one_out_UPPERRIGHT_stationInd_' + str(stationInd) + '_' + 'ROI_' + str(maskType) + '_AVGREMOVE_' + str(removeAvg)  + '_filter_' + str(filterType) + '_k1_' + str(k1) + '_k2_' + str(k2)  + '.sav'
    pickle.dump(clf,open(filename, 'wb'))

# save subject average used to later do the same thing for that subject
if removeAvg:
    average_signal_fn = 'saved_classifiers' + '/' + 'averageSignal' + '_' + 'ROI_' + str(maskType) + '_AVGREMOVE_' + str(removeAvg) + '_filter_' + str(filterType) + '_k1_' + str(k1) + '_k2_' + str(k2) + '.npy'
